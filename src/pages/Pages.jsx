      ...
      <div className="placeholder-content">
        <div className="info-box">
          ...
          <ul className="feature-list">
            <li><Icon name="writing" size={20} /> <strong>Blogs:</strong> Blog posts and articles</li>
            <li><Icon name="logbook" size={20} /> <strong>Devlogs:</strong> Development logs with to-do lists</li>
            <li><Icon name="parchment" size={20} /> <strong>Notes:</strong> Quick notes and ideas</li>
            <li><Icon name="castle" size={20} /> <strong>Projects:</strong> Full project pages with status tracking</li>
          </ul>
          <p>
