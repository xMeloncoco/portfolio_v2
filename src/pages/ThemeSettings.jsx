      ...
      <div className="placeholder-content">
        <div className="info-box">
          ...
          <ul className="feature-list">
            <li><Icon name="theme" size={20} /> Switch between different color themes</li>
            <li><Icon name="potted-plant" size={20} /> Preview themes before applying</li>
            <li><Icon name="leaf" size={20} /> Customize theme variables</li>
          </ul>
          <p>
